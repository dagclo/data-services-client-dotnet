...
namespace Quadient.DataServices.Model.Address
{
    ...
    public partial class BaseAddress : IEquatable<BaseAddress>, IValidatableObject
    {
        ...
        public BaseAddress(string Organization = default(string), List<string> AddressLines = default(List<string>), string City = default(string), string County = default(string), string ProvinceOrState = default(string), string PostalCode = default(string), string Country = default(string))
        {
            // to ensure "AddressLines" is required (not null)
            if (AddressLines == null)
            {
                throw new InvalidDataException("AddressLines is a required property for BaseAddress and cannot be null");
            }
            else
            {
            ...
            if (Country == null)
            {
                throw new InvalidDataException("Country is a required property for BaseAddress and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as BaseAddress);
        }

        /// <summary>
        /// Returns true if BaseAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of BaseAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseAddress input)
        {
            if (input == null)
                return false;
