...
namespace Quadient.DataServices.Model.Address
{
    ...
    public partial class CorrectionResponseAddress : IEquatable<CorrectionResponseAddress>, IValidatableObject
    {
        ...
        public CorrectionResponseAddress(string Organization = default(string), List<string> AddressLines = default(List<string>), string City = default(string), string County = default(string), string ProvinceOrState = default(string), string PostalCode = default(string), string Country = default(string), List<string> RegionalLines = default(List<string>))
        {
            // to ensure "AddressLines" is required (not null)
            if (AddressLines == null)
            {
                throw new InvalidDataException("AddressLines is a required property for CorrectionResponseAddress and cannot be null");
            }
            else
            {
            ...
            if (Country == null)
            {
                throw new InvalidDataException("Country is a required property for CorrectionResponseAddress and cannot be null");
            }
            else
            {
