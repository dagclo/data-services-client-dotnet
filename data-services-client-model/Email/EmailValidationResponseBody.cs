...
namespace Quadient.DataServices.Model.Email
{
    ...
    public partial class EmailValidationResponseBody : IEquatable<EmailValidationResponseBody>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="EmailRecords">EmailRecords.</param>
        public EmailValidationResponseBody(List<EmailValidationResponse> EmailRecords = default(List<EmailValidationResponse>))
        {
        ...
        {
            return this.Equals(input as EmailValidationResponseBody);
        }

        /// <summary>
        /// Returns true if EmailValidationResponseBody instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailValidationResponseBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailValidationResponseBody input)
        {
            if (input == null)
                return false;
