...
namespace Quadient.DataServices.Model.Job
{
    ...
    public partial class HourlyUsageAggregation : DailyUsageAggregation,  IEquatable<HourlyUsageAggregation>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as HourlyUsageAggregation);
        }

        /// <summary>
        /// Returns true if HourlyUsageAggregation instances are equal
        /// </summary>
        /// <param name="input">Instance of HourlyUsageAggregation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HourlyUsageAggregation input)
        {
            if (input == null)
                return false;
