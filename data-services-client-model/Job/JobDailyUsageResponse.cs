...
{
    /// <summary>
    /// JobDailyUsageResponse
    /// </summary>
    [DataContract]
    public partial class JobDailyUsageResponse : List<DailyUsageAggregation>,  IEquatable<JobDailyUsageResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobDailyUsageResponse" /> class.
        /// </summary>
        [JsonConstructor]
        public JobDailyUsageResponse() : base()
        {
        }
        ...
        {
            return this.Equals(input as JobDailyUsageResponse);
        }

        /// <summary>
        /// Returns true if JobDailyUsageResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of JobDailyUsageResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobDailyUsageResponse input)
        {
            if (input == null)
                return false;
