...
namespace Quadient.DataServices.Model.Job
{
    ...
    /// </summary>
    [DataContract]
    public partial class JobSettingsRequest :  IEquatable<JobSettingsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobSettingsRequest" /> class.
        /// </summary>
        [JsonConstructor]
        public JobSettingsRequest()
        {
        }
        ...
        {
            return this.Equals(input as JobSettingsRequest);
        }

        /// <summary>
        /// Returns true if JobSettingsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of JobSettingsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobSettingsRequest input)
        {
            if (input == null)
                return false;
