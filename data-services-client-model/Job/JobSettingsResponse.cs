...
namespace Quadient.DataServices.Model.Job
{
    ...
    /// </summary>
    [DataContract]
    public partial class JobSettingsResponse : IEquatable<JobSettingsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobSettingsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public JobSettingsResponse()
        {
        }
        ...
        {
            return this.Equals(input as JobSettingsResponse);
        }

        /// <summary>
        /// Returns true if JobSettingsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of JobSettingsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobSettingsResponse input)
        {
            if (input == null)
                return false;
