...
namespace Quadient.DataServices.Model.Job
{
    ...
    public partial class UsageAggregation : IEquatable<UsageAggregation>, IValidatableObject
    {
        ...
        public UsageAggregation(bool? Finalized = default(bool?), Object ServiceUse = default(Object))
        {
        ...
        {
            return this.Equals(input as UsageAggregation);
        }

        /// <summary>
        /// Returns true if UsageAggregation instances are equal
        /// </summary>
        /// <param name="input">Instance of UsageAggregation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsageAggregation input)
        {
            if (input == null)
                return false;
