...
namespace Quadient.DataServices.Model.Job
{
    ...
    /// </summary>
    [DataContract]
    public partial class UsageQueryResponse : IEquatable<UsageQueryResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsageQueryResponse" /> class.
        /// </summary>
        /// <param name="Total">Defines a set of usage metrics for each of the services that has been consumed in total..</param>
        /// <param name="Groups">Groups.</param>
        public UsageQueryResponse(Object Total = default(Object), List<UsageQueryGroupItem> Groups = default(List<UsageQueryGroupItem>))
        {
            this.Total = Total;
            this.Groups = Groups;
        }
        ...
        {
            return this.Equals(input as UsageQueryResponse);
        }

        /// <summary>
        /// Returns true if UsageQueryResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UsageQueryResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsageQueryResponse input)
        {
            if (input == null)
                return false;
