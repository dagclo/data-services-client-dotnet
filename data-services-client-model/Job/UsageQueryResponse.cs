...
namespace Quadient.DataServices.Model.Job
{
    ...
    public partial class UsageQueryResponse :  IEquatable<UsageQueryResponse>, IValidatableObject
    {
        ...
        public UsageQueryResponse(UsageQueryResponseTotal Total = default(UsageQueryResponseTotal), List<UsageQueryGroupItem> Groups = default(List<UsageQueryGroupItem>))
        {
            this.Total = Total;
            this.Groups = Groups;
        }
