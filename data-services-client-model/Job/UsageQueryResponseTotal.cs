...
{
    /// <summary>
    /// UsageQueryResponseTotal
    /// </summary>
    [DataContract]
    public partial class UsageQueryResponseTotal :  IEquatable<UsageQueryResponseTotal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsageQueryResponseTotal" /> class.
        /// </summary>
        /// <param name="ServiceUse">Defines a set of usage metrics for each of the services that has been consumed in total..</param>
        public UsageQueryResponseTotal(Object ServiceUse = default(Object))
        {
        ...
        {
            return this.Equals(input as UsageQueryResponseTotal);
        }

        /// <summary>
        /// Returns true if UsageQueryResponseTotal instances are equal
        /// </summary>
        /// <param name="input">Instance of UsageQueryResponseTotal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsageQueryResponseTotal input)
        {
            if (input == null)
                return false;
