...
namespace Quadient.DataServices.Model.Pricebook
{
    ...
    public partial class Pricesheet :  IEquatable<Pricesheet>, IValidatableObject
    {
        ...
        public Pricesheet(DateTime? FromDate = default(DateTime?), DateTime? ToDate = default(DateTime?), bool? IncludesAllPrices = default(bool?), string Tenant = default(string), string UserId = default(string), List<PricesWrapper> Services = default(List<PricesWrapper>))
        {
        ...
        public List<PricesWrapper> Services { get; set; }
