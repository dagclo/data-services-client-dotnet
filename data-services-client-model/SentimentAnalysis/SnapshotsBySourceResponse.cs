...
{
    /// <summary>
    /// SnapshotsBySourceResponse
    /// </summary>
    [DataContract]
    public partial class SnapshotsBySourceResponse : IEquatable<SnapshotsBySourceResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SnapshotsBySourceResponse" /> class.
        /// </summary>
        /// <param name="Sources">Sources.</param>
        public SnapshotsBySourceResponse(List<SnapshotResponse> Sources = default(List<SnapshotResponse>))
        {
        ...
        public List<SnapshotResponse> Sources { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SnapshotsBySourceResponse {\n");
        ...
        {
            return this.Equals(input as SnapshotsBySourceResponse);
        }

        /// <summary>
        /// Returns true if SnapshotsBySourceResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SnapshotsBySourceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SnapshotsBySourceResponse input)
        {
            if (input == null)
                return false;
