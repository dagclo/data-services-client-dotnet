...
{
    /// <summary>
    /// SnapshotsByTopicResponse
    /// </summary>
    [DataContract]
    public partial class SnapshotsByTopicResponse : IEquatable<SnapshotsByTopicResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SnapshotsByTopicResponse" /> class.
        /// </summary>
        /// <param name="Topics">Topics.</param>
        public SnapshotsByTopicResponse(List<SnapshotResponse> Topics = default(List<SnapshotResponse>))
        {
            this.Topics = Topics;
        }
        ...
        public List<SnapshotResponse> Topics { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SnapshotsByTopicResponse {\n");
        ...
        {
            return this.Equals(input as SnapshotsByTopicResponse);
        }

        /// <summary>
        /// Returns true if SnapshotsByTopicResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SnapshotsByTopicResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SnapshotsByTopicResponse input)
        {
            if (input == null)
                return false;
