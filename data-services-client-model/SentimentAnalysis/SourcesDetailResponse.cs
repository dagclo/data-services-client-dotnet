...
{
    /// <summary>
    /// SourcesDetailResponse
    /// </summary>
    [DataContract]
    public partial class SourcesDetailResponse : IEquatable<SourcesDetailResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SourcesDetailResponse" /> class.
        /// </summary>
        /// <param name="Sources">Sources.</param>
        public SourcesDetailResponse(List<SourceDetailResponse> Sources = default(List<SourceDetailResponse>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SourcesDetailResponse {\n");
        ...
        {
            return this.Equals(input as SourcesDetailResponse);
        }

        /// <summary>
        /// Returns true if SourcesDetailResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SourcesDetailResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SourcesDetailResponse input)
        {
            if (input == null)
                return false;
