...
namespace Quadient.DataServices.Model.SentimentAnalysis
{
    ...
    /// </summary>
    [DataContract]
    public partial class SuggestedTopicResponse : IEquatable<SuggestedTopicResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SuggestedTopicResponse" /> class.
        /// </summary>
        /// <param name="Topics">Topics.</param>
        public SuggestedTopicResponse(List<SuggestedTopic> Topics = default(List<SuggestedTopic>))
        {
            this.Topics = Topics;
        }
        ...
        public List<SuggestedTopic> Topics { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SuggestedTopicResponse {\n");
        ...
        {
            return this.Equals(input as SuggestedTopicResponse);
        }

        /// <summary>
        /// Returns true if SuggestedTopicResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SuggestedTopicResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SuggestedTopicResponse input)
        {
            if (input == null)
                return false;
