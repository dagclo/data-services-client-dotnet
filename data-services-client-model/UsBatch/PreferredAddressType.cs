...
{
    /// <summary>
    /// Specifies which address element to use when more than one type is provided.
    /// </summary>
    /// <value>Specifies which address element to use when more than one type is provided.</value>
