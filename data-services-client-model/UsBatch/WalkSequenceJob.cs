...
namespace Quadient.DataServies.Model.UsBatch
{
    ...
    public partial class WalkSequenceJob :  IEquatable<WalkSequenceJob>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as WalkSequenceJob);
        }

        /// <summary>
        /// Returns true if WalkSequenceJob instances are equal
        /// </summary>
        /// <param name="input">Instance of WalkSequenceJob to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WalkSequenceJob input)
        {
            if (input == null)
                return false;
