...
namespace Quadient.DataServices.Model.User
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiKeyListing : List<ApiKeySummary>,  IEquatable<ApiKeyListing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiKeyListing" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ApiKeyListing);
        }

        /// <summary>
        /// Returns true if ApiKeyListing instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiKeyListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiKeyListing input)
        {
            if (input == null)
                return false;
