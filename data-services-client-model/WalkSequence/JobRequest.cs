...
namespace Quadient.DataServies.Model.WalkSequence
{
    ...
    /// </summary>
    [DataContract]
    public partial class JobRequest :  IEquatable<JobRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public JobRequest(string ParentJob = default(string), WalkSequenceConfiguration Configuration = default(WalkSequenceConfiguration), List<WalkSequenceInputField> InputFields = default(List<WalkSequenceInputField>), List<WalkSequenceOutputField> OutputFields = default(List<WalkSequenceOutputField>))
        {
        ...
        {
            return this.Equals(input as JobRequest);
        }

        /// <summary>
        /// Returns true if JobRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of JobRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobRequest input)
        {
            if (input == null)
                return false;
