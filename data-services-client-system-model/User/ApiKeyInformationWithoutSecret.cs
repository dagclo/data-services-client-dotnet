...
namespace Quadient.DataServices.System.Model.User
{
	...
	/// </summary>
	[DataContract]
	public partial class ApiKeyInformationWithoutSecret : IEquatable<ApiKeyInformationWithoutSecret>, IValidatableObject
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="ApiKeyInformationWithoutSecret" /> class.
		/// </summary>
		...
		public ApiKeyInformationWithoutSecret(string Id = default(string), bool? Enabled = default(bool?))
		{
			this.Id = Id;
		...
		public override string ToString()
		{
			...
			sb.Append("class ApiKeyInformationWithoutSecret {\n");
		...
		{
			return this.Equals(input as ApiKeyInformationWithoutSecret);
		}

		/// <summary>
		/// Returns true if ApiKeyInformationWithoutSecret instances are equal
		/// </summary>
		/// <param name="input">Instance of ApiKeyInformationWithoutSecret to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ApiKeyInformationWithoutSecret input)
		{
			if (input == null)
				return false;
