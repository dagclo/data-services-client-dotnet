...
namespace Quadient.DataServices.System.Model.User
{
    ...
    public partial class ServiceAccessDescriptor :  IEquatable<ServiceAccessDescriptor>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceAccessDescriptor {\n");
        ...
        {
            return this.Equals(input as ServiceAccessDescriptor);
        }

        /// <summary>
        /// Returns true if ServiceAccessDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceAccessDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceAccessDescriptor input)
        {
            if (input == null)
                return false;
