...
namespace Quadient.DataServices.System.Model.User
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserSettingsResponse :  IEquatable<UserSettingsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserSettingsResponse" /> class.
        /// </summary>
        /// <param name="Namespaces">Namespaces.</param>
        public UserSettingsResponse(UserSettingsResponseNamespaces Namespaces = default(UserSettingsResponseNamespaces))
        {
        ...
        public UserSettingsResponseNamespaces Namespaces { get; set; }
        ...
        {
            return this.Equals(input as UserSettingsResponse);
        }

        /// <summary>
        /// Returns true if UserSettingsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UserSettingsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserSettingsResponse input)
        {
            if (input == null)
                return false;
