...
namespace Quadient.DataServices.System.Model.User
{
    ...
    public partial class UserUpdateRequest :  IEquatable<UserUpdateRequest>, IValidatableObject
    {
        ...
        /// <param name="ServiceConfigurations">A collection of currently existing service configurations that this user is to belong to..</param>
        /// <param name="AdditionalDetails">Additional details about the user..</param>
        public UserUpdateRequest(string Username = default(string), string EmailAddress = default(string), string FirstName = default(string), string LastName = default(string), string Origin = default(string), bool? Enabled = default(bool?), string Password = default(string), List<string> Groups = default(List<string>), List<string> ServiceConfigurations = default(List<string>), Object AdditionalDetails = default(Object))
        {
        ...
        /// <summary>
        /// A collection of currently existing service configurations that this user is to belong to.
        /// </summary>
        /// <value>A collection of currently existing service configurations that this user is to belong to.</value>
